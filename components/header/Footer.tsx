      ...
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div className="justify-between sm:flex">
          <div className="space-y-6">
            ...
            <p className="max-w-md dark:text-gray-400 text-gray-700">
              ChatGlobe is a chat application that allows you to chat with
              anyone, any document, in any language.
            </p>
            <ul className="flex flex-wrap items-center gap-4 text-sm sm:text-base">
              {footerNavs.map((item, idx) => (
                <li
                  key={idx}
                  className="dark:text-gray-400 text-gray-800 hover:text-gray-500 duration-150"
                >
          ...
          <div className="mt-6">
            <p className="dark:text-gray-400 text-gray-700 font-semibold">
              Get the app
            </p>
        ...
        <div className="mt-10 py-5 border-t md:text-center">
          <p>© 2022 ChatGlobe Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
